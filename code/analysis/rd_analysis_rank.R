...
knitr::opts_current$set(label = "rd_analysis_rank")
...
is Ranking(no. of innovations), where higher is more innovative, and the independent (running) variable is 
...
make_table(models,
  ...
  kableExtra::save_kable("./tables/rd_analysis_rank.tex")
